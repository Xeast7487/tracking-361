...
const CSS = `
  ...
  @keyframes miaBody {
    0%       { transform: translate(-60px, 130px) }       /* off-screen left */
    7%       { transform: translate(100px, 130px) }        /* rushes in */
    9%       { transform: translate(100px, 130px) }
    /* HIT 1 @ 1.30s – Mia punches EC */
    15%      { transform: translate(130px, 130px) rotate(-10deg) }
    19%      { transform: translate(100px, 130px) rotate(0deg) }
    /* HIT 2 @ 2.50s – EC counter, Mia staggers back */
    27%      { transform: translate(74px,  130px) rotate(8deg) }
    31%      { transform: translate(100px, 130px) rotate(0deg) }
    /* HIT 3 @ 3.75s – Mia big lunge */
    41%      { transform: translate(136px, 130px) rotate(-14deg) }
    45%      { transform: translate(100px, 130px) rotate(0deg) }
    /* HIT 4 @ 5.00s – EC desperate, Mia recoils */
    55%      { transform: translate(78px,  130px) rotate(9deg) }
    59%      { transform: translate(100px, 130px) rotate(0deg) }
    /* JUMP KICK @ 6.10s */
    64%      { transform: translate(100px, 114px) rotate(-5deg) }   /* liftoff */
    67%      { transform: translate(140px, 100px) rotate(-18deg) }  /* flying kick */
    70%      { transform: translate(100px, 130px) rotate(0deg) }    /* lands */
    /* CHARGE UP 7.00–7.70s */
    78%      { transform: translate(100px, 136px) rotate(5deg) }    /* crouch */
  ...
  @keyframes ecBody {
    0%       { transform: translate(660px, 130px) }       /* off-screen right */
    7%       { transform: translate(342px, 130px) }        /* rushes in */
...
/* pre-compute the radial spark arrays */
...
export default function ExplosionLoader() {
  ...
  useEffect(() => {
    const t = setTimeout(() => setGone(true), 9700)
        ...
        <div className="arena-wrap">
          ...
          <div className="hb-row">
            <div className="hb-col" style={{ alignItems: 'flex-end' }}>
              <div className="hb-name hb-name-l">Mia</div>
