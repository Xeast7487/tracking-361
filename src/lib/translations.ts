...
export const translations = {
  fr: {
    ...
    adminReports: {
      ...
      chargeClient: 'Facturer client',
      chargeClientOnly: 'Client seulement',
      clientBillingTitle: 'Facturation clients',
      clientBillingTotal: 'Total à facturer',
    ...
    clock: {
      ...
      billableHours: 'Heures facturables',
      chargeWebDept: 'Charger au département web',
      chargeClient: 'Facturer au client',
      clientHourlyRate: 'Taux horaire client ($/h)',
      clientBillingPreview: 'Facturation estimée au client',
      ...
      billable: 'Facturable',
      nonBillable: 'Non facturable',
      chargeClientBadge: 'Facturer client',
      startedAt: 'Démarré à',
      resume: '▶ Reprendre',
      resuming: 'Reprise...',
      pause: '⏸ Pause',
    ...
    entries: {
      ...
      chargeClientYes: 'Facturer client',
      total: 'Total',
    ...
    export: {
      csvHeaders: ['Employé', 'Date', 'Heure début', 'Heure fin', 'Durée (h)', 'Client', 'Projet', 'Facturable', 'Facturer client', 'Taux client ($/h)', 'Montant client ($)', 'Notes'],
      inProgress: 'En cours',
      yes: 'Oui',
      no: 'Non',
  ...
  en: {
    ...
    adminReports: {
      ...
      chargeClient: 'Bill client',
      chargeClientOnly: 'Client only',
      clientBillingTitle: 'Client billing',
      clientBillingTotal: 'Total to invoice',
    ...
    clock: {
      ...
      chargeClient: 'Bill to client',
      clientHourlyRate: 'Client hourly rate ($/h)',
      clientBillingPreview: 'Estimated client billing',
    ...
    export: {
      csvHeaders: ['Employee', 'Date', 'Start time', 'End time', 'Duration (h)', 'Client', 'Project', 'Billable', 'Bill client', 'Client rate ($/h)', 'Client amount ($)', 'Notes'],
      inProgress: 'In progress',
      yes: 'Yes',
      no: 'No',
